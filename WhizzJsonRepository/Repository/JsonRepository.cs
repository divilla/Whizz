...
using WhizzJsonRepository.JsonValidate;
...
namespace WhizzJsonRepository.Repository
{
    public class JsonRepository : IRepository
    {
        ...
        public virtual Func<string, string> ToDbCase => (s) => s.ToSnakeCase(); 
        public virtual Func<string, string> DbQuotedCaseResolver => (s) => Quote(s.ToSnakeCase()); 
        public virtual Case JsonCase => Case.Camel;
        public virtual Func<string, string> ToJsonCase => (s) => s.ToCamelCase();
        ...
        {
            return new FindJsonInvoker(this, relationName, schemaName);
        }
        ...
        private async Task<object> _findAsync(string func, JObject whereData, string relationName, string schemaName = DbSchema.DefaultSchema)
        {
            ...
            var resolvedWhereData = whereData.ResolvePropertyNames(ToDbCase);
