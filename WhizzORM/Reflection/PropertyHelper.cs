    ...
    public abstract class PropertyHelper
    {
        ...
        public static Func<object, TResult> MakeFastPropertyGetter<TResult>(PropertyInfo propertyInfo)
        {
            try
            {
                ...
                return (Func<object, TResult>) propertyGetterDelegate;
        ...
        protected PropertyInfo FindPropertyWithAttribute<TAttribute>()
            ...
            => Properties.FirstOrDefault(pr => pr.GetCustomAttribute(typeof(TAttribute), true) != null);

        protected void ThrowNewInvalidOperationExceptionIfNull(object value, string propertyName)
        {
            if (value == null)
            {
                throw new InvalidOperationException($"{propertyName} could not be found on the provided {Reflection.ToFriendlyTypeName(this.Type)}. The property should be specified manually by providing component instance or using the specified helper methods.");
            }
        }
