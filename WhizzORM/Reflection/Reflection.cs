    ...
    public static class Reflection
    {
            ...
            DeepEqualityResult result)
        {
            ...
            if (expectedType == objectType || expectedTypeIsAnonymous)
                return ComparablesAreDeeplyEqual(expected, actual, result)
                    ? result.Success
                    : ObjectPropertiesAreDeeplyEqual(expected, actual, processedElements, result);
            ...
            DeepEqualityResult result)
        {
            ...
            for (var i = 0; i < listOfExpectedValues.Count; i++)
            {
